...
public class MainCameraController : MonoBehaviour
{
    ...
    public Quaternion flatRotation => Quaternion.Euler(0, rotY, 0); //tää estää ettei mee joka suuntaan niinkun avaruusalus kameran mukaan.. et spacesceneen note to self
    /*sama ku class jos tarvis muutella enemmän johkin 
